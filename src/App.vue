...
import FunctionalTest from './components/FunctionalTest.vue';
import FunctionalTest2 from './components/FunctionalTest2';
import FunctionalTest3 from './components/FunctionalTest3.vue';
